...
$lang = array(
    ...
    "Programmation" => "IT Development",
    "Programmes" => "Website creation, SEO, Hosting, Dynamic website with database creation, Software solution, Task automation ...",
    "En savoir plus" => "Learn More",
    "Graphisme" => "Graphics",
    "Logos" => "Logos, Illustration, Graphic chart, Web design, Posters, Overlays, Animation ...",
    "Photographie" => "Photography",
    "Portraits" => "Portrait, Background, Scenes, Macro, Panning shot, Product photos, Retouching, Social network shots ...",
    "Vidéo" => "Video/Editing",
    "Montages" => "Shooting, Business presentation, Video editing, Post-production, Short film ...",
    "Support" => "IT Support",
    "Réparation" => "Computer repair or improvement, Special project request, Accompaniment and advice for digitalization projects, Teaching ...",
    "À" => "A",
    "PROPOS" => "BOUT",
